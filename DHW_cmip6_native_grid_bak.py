...
subprocess.call('scp '+basedir+'/tos_*/processed_native_grid/dhw* /home/shared/for_ben/processed_native_grid', shell=True)
os.remove(lock_file3)
touch('/home/shared/for_ben/processed_native_grid/all_processed')
