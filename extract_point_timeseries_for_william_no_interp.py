...
my_dict["CanESM5"] = {}
my_dict["CanESM5"]["CanESM5"] = [(-9.8494, 143.500000),(-10.5948, 143.500000),(-11.3851, 143.500000),(-18.6621, 152.500000),(-21.4785, 152.500000),(-22.4061, 152.500000),(-23.3275, 151.500000)]
        ...
        if model_in_directory(hist_dir,model,variable) and model_in_directory(future_directories[future_directory],model,variable):
            ...
            if not(test):
                ...
                for lat_lon_target in my_dict[model]["point_locations"]:
                    ...
                    #put the above data alongside its date data into a pandas dataframe
                    ...
                    #slot the above data into the right dates in the dataframe which is holding the data for all of the diggreent geographical points (doing thsi way in case the date range of any of the futrure scenario netcdf files are different from each other)
