...
# directories = ['test_day_ssp585_r1i1p1f1_r1i1p1f2']
hist_directory = 'tos_day_historical_r1i1p1f1_r1i1p1f2'
# hist_directory = 'test_hist'
###########
...
for directorie in directories:
    ...
    for model in models:
        try:
            print(model)
            # file = basedir+'tos_day_'+directorie.split('_')[2]+'_r1i1p1f1_r1i1p1f2/'+subdir+'/tos_Oday_'+model+'_hist_'+directorie.split('_')[2]+'_GBR.nc'
            file = basedir+directorie+'/'+subdir+'/tos_Oday_'+model+'_hist_'+directorie.split('_')[2]+'_GBR.nc'
            print(file)
            try:
                os.mkdir(basedir+directorie+'/'+subdir)
            except:
                pass
            if os.path.exists(file):
                output_filename = basedir+directorie+'/'+subdir+'/dhw_Oday_'+model+'_hist_'+directorie.split('_')[2]+'_GBR.nc'
                output_filename2 = basedir+directorie+'/'+subdir+'/dhw_Oday_'+model+'_hist_'+directorie.split('_')[2]+'_GBR_ann_max.nc'
                # output_filename = basedir+'tos_day_'+directorie.split('_')[2]+'_r1i1p1f1_r1i1p1f2/'+subdir+'/dhw_Oday_'+model+'_hist_'+directorie.split('_')[2]+'_GBR.nc'
                # output_filename2 = basedir+'tos_day_'+directorie.split('_')[2]+'_r1i1p1f1_r1i1p1f2/'+subdir+'/dhw_Oday_'+model+'_hist_'+directorie.split('_')[2]+'_GBR_ann_max.nc'
                mmm_file = basedir+hist_directory+'/'+subdir+'/'+model+'_mmm.nc'
...
# subprocess.call('cp -n '+basedir+'/tos_*/'+subdir+'/dhw* /home/shared/for_ben/dec_2020/'+subdir, shell=True)
# os.remove(lock_file3)
# touch('/home/shared/for_ben/dec_2020/'+subdir+'/all_processed')
